...
Patch0:		%{name}-1.2.8-slice2cpp.patch
...
#symlink for celt071
ln -s ../libcelt.so.0.0.0 %{buildroot}%{_libdir}/%{name}/libcelt.so.0.7.1
...
%changelog
* Tue Jan 27 2015 Romain Acciari <romain.acciari@openio.io> - 1.2.8-1
- Update 1.2.8
