...
%define _cyrlibexecdir %{_exec_prefix}/libexec
...
Source0: Cyrus-OpenIO.tar.gz
Source1: cyrus-imapd.logrotate
Source2: cyrus-imapd.imap-3.0.x-openio-conf
...
install -p -m 644 master/conf/small.conf %{buildroot}%{_sysconfdir}/cyrus.conf
...
mv -f %{buildroot}%{_exec_prefix}/libexec/master         %{buildroot}%{_exec_prefix}/libexec/cyrus-master
...
# Fix wrong manpage
mv -f %{buildroot}%{_mandir}/manr/imapd.conf.rst %{buildroot}%{_mandir}/man5/
rmdir %{buildroot}%{_mandir}/manr
...
- OpenIO is enabled and configured by default for a development environment
