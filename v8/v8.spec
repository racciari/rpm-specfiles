...
Patch3:     v8-3.11.10-shebangs.patch
...
g++ $RPM_OPT_FLAGS -o d8 obj/release/debug.os obj/release/platform-posix.os obj/release/d8.os -lpthread -lreadline -lpthread -L. -lv8 $ICU_LINK_FLAGS
...
%changelog
* Sun Jun 21 2015 Romain Acciari <romain.acciari@openio.io> - 3.11.10-1
- tag 3.11.10
